...
def main(cfg):
    ...
    if os.path.exists(f"./saved/dlv3_os_{cfg['output_stride']}_checkpoint.pth"):
        history = load_file(f"./saved/dlv3_os_{cfg['output_stride']}_history.pkl")
        checkpoint = torch.load(f"./saved/dlv3_os_{cfg['output_stride']}_checkpoint.pth", map_location=DEVICE)
    ...
    for epoch in range(cfg["epochs"]):
        ...
        }, f"./saved/dlv3_os_{cfg['output_stride']}_checkpoint.pth")
        save_file(history, f"./saved/dlv3_os_{cfg['output_stride']}_history.pkl")

    torch.save(model.state_dict(), f"./saved/dlv3_os_{cfg['output_stride']}_e_{epoch+1}.pth")
